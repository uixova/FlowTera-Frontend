...
const Loader = ({ type = 'butterfly', text = 'Yükleniyor...' }) => {
  ...
  const DotsLoader = () => (
    <div className="tr-dots-container">
      <div className="tr-dots-loader">
  ...
  return type === 'butterfly' ? <ButterflyLoader /> : <DotsLoader />;
};
