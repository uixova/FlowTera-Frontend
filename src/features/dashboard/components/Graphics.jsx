...
const MonthlyReport = ({ trendData, distributionData, typeData, teamData }) => {
    const { t } = useTranslation('dashboard.graphics');
        ...
        <div className="monthly-grid">
            ...
            <div className="report-card">
                <div className="report-header">
                    <div className="report-panel-left">
                        ...
                        <h3>{t('spending_analytics')}</h3>
                    </div>
                    <span className="report-period">{t('trend_all_time')}</span>
                </div>
            ...
            <div className="report-card">
                <div className="report-header">
                    ...
                    <span className="report-period">{t('by_count')}</span>
                </div>
                <div className="chart-wrapper">
                    <ResponsiveContainer width="100%" height={250}>
            ...
            <div className="report-card">
                <div className="report-header">
                    <div className="report-panel-left">
                        ...
                        <h3>{t('type_comparison')}</h3>
                    </div>
                    <span className="report-period">{t('distribution_label')}</span>
                </div>
                <div className="chart-wrapper">
                    <ResponsiveContainer width="100%" height={250}>
                        <PieChart>
            ...
            <div className="report-card">
                <div className="report-header">
                    <div className="report-panel-left">
                        ...
                        <h3>{t('team_analysis')}</h3>
                    </div>
                    <span className="report-period">{t('cost_label')}</span>
                </div>
                <div className="chart-wrapper">
                    <ResponsiveContainer width="100%" height={250}>
